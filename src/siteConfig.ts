export const siteConfig = {
  ...
  social: {
    ...
    notion: 'https://notion.so/pennfly', // Placeholder based on handle
  },
  contact: {
    email: 'pennfly2008@gmail.com',
    phone: '400-123-4567', // Keep existing placeholder if not provided, or remove
    address: '北京市海淀区中关村', // Keep existing placeholder
  }
};
